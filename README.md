...
python code/gbq_city/gbq_all_1.py --test_run
```
...
- Alternatively, to submit all jobs, run: `python code/gbq_city/gbq_all_1.py`
The script `code/gbq_city/gbq_all_1.py` generates `.sh` files for job submission and submits them.
